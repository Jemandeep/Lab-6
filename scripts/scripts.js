document.addEventListener("DOMContentLoaded", function() {
    ...
    const INITIAL_MODEL_NAME = "XYZ";
    const INITIAL_DURATION = 1;

    let modelName = INITIAL_MODEL_NAME;
    ...
    /* create a function called recalculate() which will
        ...
        - set the value of the calculated-cost element's textContent to this new value
    */
    ...
    - second, create a function called changeModel() which checks the value of the model name variable. This function will:
        ...
        - if modelName is currently "XYZ", change the value of modelName to "CPRG", and change the textContent of the model-text span element to "Model CPRG"
        - if modelName is currently "CPRG", change the value of modelName to "XYZ", and change the textContent of the model-text span element to "Model XYZ"
    ...
    /*  - first, create a variable to represent the "Change Duration" pseudo-button.
        - then, create a function called changeDuration() that will
            ...
            - change the textContent of the duration-text span element to this new value
